...
from izengzhi.apps.courses.models import Course
from izengzhi.apps.operation.models import UserFavorite
...
class TeacherListView(View):
    def get(self, request):
        ...
        # 教师排行榜
        sorted_teachers = all_teachers.order_by('-click_num')[:2]
...
class TeacherDetailView(View):
    def get(self, request, teacher_id):
        ...
        sorted_teachers = Teacher.objects.all().order_by('-click_num')[:2]
